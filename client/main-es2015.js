...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"overlay\" *ngIf=\"isShowed\">\n  <div>\n   \n  </div>\n</div>");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-confirm-order-confirm-order-module */ "pages-confirm-order-confirm-order-module").then(__webpack_require__.bind(null, /*! ./pages/confirm-order/confirm-order.module */ "./src/app/pages/confirm-order/confirm-order.module.ts")).then(m => m.ConfirmOrderPageModule)
    },
    {
        path: 'validate-order-code',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-validate-order-code-validate-order-code-module */ "pages-validate-order-code-validate-order-code-module").then(__webpack_require__.bind(null, /*! ./pages/validate-order-code/validate-order-code.module */ "./src/app/pages/validate-order-code/validate-order-code.module.ts")).then(m => m.ValidateOrderCodePageModule)
    },
    {
        path: 'faq',
...
/* harmony import */ var _services_printer_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/printer.service */ "./src/app/services/printer.service.ts");
...
/* harmony import */ var ng_connection_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ng-connection-service */ "./node_modules/ng-connection-service/__ivy_ngcc__/fesm2015/ng-connection-service.js");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, translate, auth, router, printerService, ordersService, loadingCtrl, connectionService) {
        ...
        this.connectionService.monitor()
            ...
            _services_global__WEBPACK_IMPORTED_MODULE_5__["Global"].CONNECTION_STATUS = isConnected ? 0 /* ONLINE */ : 1 /* OFFLINE */;
            if (isConnected) {
        ...
        _services_global__WEBPACK_IMPORTED_MODULE_5__["Global"].validationSuccess.subscribe(res => {
    ...
    handleKeyboardEvent(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (event.key == 'Enter') {
                try {
                    let data = JSON.parse(atob(this.scan_text));
                    console.log(data);
                    let id = data.id;
                    if (data.confirm) {
    ...
    validate(code) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (_services_global__WEBPACK_IMPORTED_MODULE_5__["Global"].CONNECTION_STATUS == 1 /* OFFLINE */) {
                this.error_component.show(0, "Errors._NO_INTERNET_CONNECTION");
                return;
            }
            let loading = yield this.loadingCtrl.create({ message: "loading..." });
            loading.present();
            let canPrint = yield this.printerService.canPrint();
            if (!canPrint) {
            ...
            this.ordersService.validateAndPrint(code)
                .subscribe(res => {
                loading.dismiss();
                this.success_component.show();
                setTimeout(() => {
...
AppComponent.propDecorators = {
    success_component: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ["success", { static: false },] }],
    error_component: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ["error", { static: false },] }],
    handleKeyboardEvent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['document:keypress', ['$event'],] }]
};
...
/* harmony import */ var _interceptors_token_interceptors__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./interceptors/token.interceptors */ "./src/app/interceptors/token.interceptors.ts");
...
/* harmony import */ var _angular_common_locales_it__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/common/locales/it */ "./node_modules/@angular/common/locales/it.js");
/* harmony import */ var _angular_common_locales_it__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_it__WEBPACK_IMPORTED_MODULE_15__);
...
/* harmony import */ var _services_global__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/global */ "./src/app/services/global.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"].forRoot({ mode: 'ios', backButtonText: '' }),
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _interceptors_token_interceptors__WEBPACK_IMPORTED_MODULE_12__["TokenInterceptor"], multi: true },
...
/* harmony import */ var _printer_animation_printer_animation_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./printer-animation/printer-animation.component */ "./src/app/components/printer-animation/printer-animation.component.ts");
...
/* harmony import */ var _success_success_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./success/success.component */ "./src/app/components/success/success.component.ts");
...
let ErrorComponent = class ErrorComponent {
    constructor() {
        this.options = { showOnStart: false, delay: 0 };
...
ErrorComponent.propDecorators = {
    ...
    successText: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['successText',] }],
    text: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['text',] }],
    callback: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"], args: ["callback",] }]
};
ErrorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'error-effect',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./error.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/error/error.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./error.component.scss */ "./src/app/components/error/error.component.scss")).default]
    })
], ErrorComponent);
...
LoadingComponent.propDecorators = {
    components: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ["components",] }]
};
LoadingComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'loading',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./loading.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/loading/loading.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./loading.component.scss */ "./src/app/components/loading/loading.component.scss")).default]
    })
], LoadingComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrinterAnimationComponent", function() { return PrinterAnimationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let PrinterAnimationComponent = class PrinterAnimationComponent {
    constructor() { }
    ngOnInit() { }
};
PrinterAnimationComponent.ctorParameters = () => [];
PrinterAnimationComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'printer-animation',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./printer-animation.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/printer-animation/printer-animation.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./printer-animation.component.scss */ "./src/app/components/printer-animation/printer-animation.component.scss")).default]
    })
...
let SuccessComponent = class SuccessComponent {
    ...
    show(time = 0) {
        setTimeout(() => {
            this.isShow = true;
            if (this.options.cashback) {
                confetti.start();
                setTimeout(() => {
                    confetti.stop();
                }, this.options.cashback.confetti.duration || 500);
            }
        }, time || 0);
    }
    hide(time = 0) {
...
SuccessComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./success.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/success/success.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./success.component.scss */ "./src/app/components/success/success.component.scss")).default]
    })
], SuccessComponent);
...
let CurrencySymbolPipe = class CurrencySymbolPipe {
    transform(value, extended = false) {
        value = (value || 'none').toUpperCase();
        let currency = CURRENCY[value] || {};
        return extended ? currency.code : currency.symbol;
    }
};
CurrencySymbolPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I18nDatePipe", function() { return I18nDatePipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let I18nDatePipe = class I18nDatePipe {
    constructor(translateservice) {
        this.translateservice = translateservice;
    }
    transform(value, format, timeZome) {
        const datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_1__["DatePipe"](this.translateservice.currentLang);
        return datePipe.transform(value, format, timeZome);
    }
};
I18nDatePipe.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] }
];
I18nDatePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _i18n_date_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./i18n-date.pipe */ "./src/app/pipes/i18n-date.pipe.ts");
/* harmony import */ var _currency_symbol_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./currency-symbol.pipe */ "./src/app/pipes/currency-symbol.pipe.ts");
...
let AuthService = class AuthService {
    ...
    networkLogin() {
        ...
        return this.http.post(_global__WEBPACK_IMPORTED_MODULE_2__["Global"].ENDPOINTS.USERS + "/login", body)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(x => {
            this.setToken(x.token);
            this.setIdentity(x.user);
            return x;
        }));
    }
};
...
class Global {
    static getDeviceStatus(short_result = true) {
        let result_short = {
            c: { s: Global.CONNECTION_STATUS },
            p: { s: Global.PRINTER_STATUS },
            qr: { s: Global.QRCODE_STATUS },
            ts: { s: Global.TOUCHSCREEN_STATUS },
        };
        let result = {
            connection: { status: Global.CONNECTION_STATUS },
            printer: { status: Global.PRINTER_STATUS },
            qrcode: { status: Global.QRCODE_STATUS },
            touchscreen: { status: Global.TOUCHSCREEN_STATUS },
        };
...
Global.CONNECTION_STATUS = 0 /* ONLINE */;
Global.PRINTER_STATUS = 0 /* ON */;
Global.TOUCHSCREEN_STATUS = 0 /* ON */;
Global.QRCODE_STATUS = 0 /* ON */;
...
let OrdersService = class OrdersService {
    ...
    findById(id) {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_3__["Global"].ENDPOINTS.ORDERS + "/orders/" + id, { params: { filter: "{}" } });
    }
    validateAndPrint(idOrCode) {
        return this.http.post(`${_global__WEBPACK_IMPORTED_MODULE_3__["Global"].ENDPOINTS.PRINTER}/orders/${idOrCode}/validate`, { id: idOrCode }, { headers: { lang: _global__WEBPACK_IMPORTED_MODULE_3__["Global"].DEFAULT_LANG } });
    }
    validateOrder(order) {
        return this.http.put(_global__WEBPACK_IMPORTED_MODULE_3__["Global"].ENDPOINTS.ORDERS + "/orders/" + order.id + "?updateFields=validated&includes=event", { validated: new Date() })
            ...
            return res;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((x) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                //let result = await FileManager.newLineAppendTo(Electron.getGlobal('__dirname') + `/${order.fk_event}/orders/validations.txt` , "" + order.id + "#" + Date.now())
            }
            catch (error) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrinterErrorStatus", function() { return PrinterErrorStatus; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/__ivy_ngcc__/fesm2015/ngx-translate-core.js");
/* harmony import */ var _pipes_currency_symbol_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pipes/currency-symbol.pipe */ "./src/app/pipes/currency-symbol.pipe.ts");
/* harmony import */ var _pipes_i18n_date_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../pipes/i18n-date.pipe */ "./src/app/pipes/i18n-date.pipe.ts");
...
let PrinterService = class PrinterService {
    ...
    printOrder(order) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let i18nDatePipe = new _pipes_i18n_date_pipe__WEBPACK_IMPORTED_MODULE_5__["I18nDatePipe"](this.translate);
            let currencySymbolPipe = new _pipes_currency_symbol_pipe__WEBPACK_IMPORTED_MODULE_4__["CurrencySymbolPipe"]();
            if (!order.movement || !order.movement.currency) {
                order.movement = { currency: 'eur' };
            }
            let current = 0;
            let total = 0;
            for (let r of order.rows) {
                total += r.qta;
            }
            let tickets = [];
            for (let r of order.rows) {
                console.log("print - " + r.name);
                for (let i = 0; i < r.qta; i++) {
                    current++;
                    let ticket = {
            ...
            return yield this.http.post(`${_global__WEBPACK_IMPORTED_MODULE_6__["Global"].ENDPOINTS.PRINTER}/tickets/print`, tickets).toPromise();
        });
    }
    checkPrinterStatus() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this.http.get(`${_global__WEBPACK_IMPORTED_MODULE_6__["Global"].ENDPOINTS.PRINTER}/status`).toPromise();
        });
    }
    canPrint() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let check_status = yield this.checkPrinterStatus();
            return check_status.status.filter(cs => cs != PrinterErrorStatus.DRAWER_OPENED && cs != PrinterErrorStatus.PAPER_TAKEOUT).length == 0;
        });
    }
};
